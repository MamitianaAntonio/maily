package com.antonio.demo.endpoint.event.consumer;

import com.antonio.demo.PojaGenerated;
import com.antonio.demo.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.antonio.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.antonio.demo.service.event."
